...
import type { BabyDresserConfig } from './types';
...
@customElement('baby-dresser')
export class BabyDresser extends LitElement {
  public static async getConfigElement(): Promise<LovelaceCardEditor> {
    await import('./editor');
    return document.createElement('baby-dresser-editor');
  }
  ...
  @state() private config!: BabyDresserConfig;

  // https://lit.dev/docs/components/properties/#accessors-custom
  public setConfig(config: BabyDresserConfig): void {
...
<ha-card
    ...
    tabindex="0"
    .label=${`Baby Dresser: ${this.config.entity || 'No Entity Defined'}`}
