...
customElements.define('action-handler-baby-dresser', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-baby-dresser')) {
    return body.querySelector('action-handler-baby-dresser') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-baby-dresser');
